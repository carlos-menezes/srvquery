![srvquery](https://shieldcn.dev/header/glow.svg?title=srvquery&subtitle=The+TypeScript+toolkit+for+querying+game+servers.&logo=false&size=wide&mode=dark&theme=emerald&align=left&font=space-grotesk)
